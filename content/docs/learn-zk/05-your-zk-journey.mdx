...
**Step 2 — Learn just enough of xark's Rust subset (a day).**
You only need the basics: `Field`, `Private`/`Public`, `require_eq`, arrays, functions, and what
the [supported subset](/docs/reference/supported-subset) accepts. Rewrite example 01 from scratch
without looking.
...
**xark & its Rust subset**
- [The supported subset](/docs/reference/supported-subset) — what lowers to a circuit and what's
  rejected. Start here.
- [The xark repo](https://github.com/blueshift-gg/xark) — `gadgets/` for the hash/curve/signature
  crates and `examples/` for runnable circuits.
