 ...
 * @returns {string}
 */
function circuit_inputs(circuit_xbc) {
    let deferred3_0;
    let deferred3_1;
    try {
...
exports.circuit_inputs = circuit_inputs;
 ...
 */
function preload(circuit_xbc, pk_bytes) {
    const ptr0 = passArray8ToWasm0(circuit_xbc, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
function proof_to_snarkjs_json(proof_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(proof_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.proof_to_snarkjs_json(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.proof_to_snarkjs_json = proof_to_snarkjs_json;
 ...
 * @returns {any}
 */
function prove(circuit_xbc, pk_bytes, inputs_json) {
    const ptr0 = passArray8ToWasm0(circuit_xbc, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(pk_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
function prove_preloaded(inputs_json) {
    const ptr0 = passStringToWasm0(inputs_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.prove_preloaded(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
}
exports.prove_preloaded = prove_preloaded;
 ...
 * @returns {string}
 */
function public_inputs_to_snarkjs_json(public_inputs_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(public_inputs_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.public_inputs_to_snarkjs_json(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.public_inputs_to_snarkjs_json = public_inputs_to_snarkjs_json;
 ...
 * @returns {boolean}
 */
function verify(vk_bytes, proof_bytes, public_inputs_bytes) {
...
const wasmPath = `${__dirname}/xark_wasm_bg.wasm`;
