 ...
 * @returns {string}
 */
function circuit_inputs(circuit_json) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 */
function preload(r1cs_json, circuit_json, pk_bytes) {
 ...
 * @returns {any}
 */
function prove(r1cs_json, circuit_json, pk_bytes, inputs_json) {
    const ptr0 = passStringToWasm0(r1cs_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(circuit_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
function prove_fast(inputs_json) {
