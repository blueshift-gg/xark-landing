 ...
 * @returns {string}
 */
export function proof_to_snarkjs_json(proof_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {any}
 */
export function prove_preloaded(inputs_json) {
 ...
 * @returns {string}
 */
export function public_inputs_to_snarkjs_json(public_inputs_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('xark_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
